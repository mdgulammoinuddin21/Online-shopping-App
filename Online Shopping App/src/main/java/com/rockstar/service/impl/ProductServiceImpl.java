...
import com.rockstar.beans.DemandBean;
import com.rockstar.beans.ProductBean;
import com.rockstar.service.ProductService;
import com.rockstar.utility.DBUtil;
import com.rockstar.utility.IDUtil;
...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public String removeProductBySupplier(String prodId, String supplierId) {
		String status = "Product Removal Failed!";
		...
		try {
			ps = con.prepareStatement("delete from product where pid=? and (supplierid=? or supplierid is null and ? is null)");
			ps.setString(1, prodId);
	...
	public List<ProductBean> getAllProducts() {
		...
		try {
			...
			while (rs.next()) {
				...
				try {
					product.setSupplierId(rs.getString(8));
				} catch (SQLException e) {
	...
	@Override
	public List<ProductBean> getProductsBySupplier(String supplierId) {
		List<ProductBean> products = new ArrayList<ProductBean>();
		...
		try {
			ps = con.prepareStatement("select * from product where supplierid=?");
