	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Rockstar Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Rockstar Electronics.<br>"
					...
					+ "<span class='greenText'>Rockstar786</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
